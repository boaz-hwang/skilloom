...
스킬은 자꾸 길어집니다. 문제를 하나 고칠 때마다 문장이 붙고, 예외를 만날 때마다 규칙이 붙습니다. 어느새 유능한 모델이 일을 시작하기도 전에 지침의 벽을 읽고 넘겨야 합니다.

Skilloom은 반대로 갑니다. 이미 손에 있는 근거, 승인한 결과물과 그때 준 피드백에서 출발해 결과가 의존하는 것만 남깁니다. 나머지는 모델이 정합니다.
